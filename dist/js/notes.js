...
(function () {
  ...
  console.log('test2');
  var API_URL_BASE = 'https://api.nytimes.com/svc/search/v2/articlesearch.json?q=[key]&api-key=[aCzqpe8z4mtAFyQ1e1fJbxXrJUJuq8zD';
  var searchEl = document.querySelector('[name="key"]'); //const valueEl = document.querySelector('[name="value"]')
  ...
  function handleGetResponse(response) {
    ...
    console.log('response!', response); //the tree to get to the value is inside response, inside data, inside another data, and there is the value. i.e  
    // response:
    //     data[
    //         data{
    //            value: "hello"
  ...
  function getData(key) {
    console.log('fetching with GET:' + key); //axios go to this url, fetch this value, then call this function 
